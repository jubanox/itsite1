  ...
  return (
    <div className="min-h-screen max-w-md mx-auto relative flex flex-col items-center" style={{ background: 'linear-gradient(135deg, #D7004D 0%, #A30032 100%)' }}>
      ...
      <div className="pt-20 pb-12">
        <img src={bradescoLogo} alt="Bradesco" className="h-14" />
      </div>
      ...
      <div className="mx-5 bg-white rounded-2xl p-8 flex flex-col items-center w-[calc(100%-40px)]">
        <div className="w-14 h-14 rounded-full bg-pink-50 flex items-center justify-center mb-4">
          <CheckCircle className="text-[#D7004D]" size={32} />
        </div>
        ...
        <div className="w-full border border-border rounded-xl p-4 flex flex-col items-center mb-4">
